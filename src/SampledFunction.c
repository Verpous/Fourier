...
{																																							\
	precision##Real max = -INFINITY;																														\
																																							\
	for (unsigned long long i = from; i < to; i += step)																									\
	{																																						\
	...
	return max;																																				\
																																							...
																																							\
precision##Real GetMin_##precision##Real(Function_##precision##Real f, unsigned long long from, unsigned long long to, unsigned long long step)				\
{																																							\
	...
	return min;																																				\
																																							...
																																							\
precision##Complex GetMax_##precision##Complex(Function_##precision##Complex f, unsigned long long from, unsigned long long to, unsigned long long step)	\
{																																							\
	...
	return maxSample;																																		\
																																							...
																																							\
precision##Complex GetMin_##precision##Complex(Function_##precision##Complex f, unsigned long long from, unsigned long long to, unsigned long long step)	\
{																																							\
